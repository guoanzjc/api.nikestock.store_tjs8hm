define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'fuzhuang/index' + location.search,
                    add_url: 'fuzhuang/add',
                    edit_url: 'fuzhuang/edit',
                    del_url: 'fuzhuang/del',
                    multi_url: 'fuzhuang/multi',
                    import_url: 'fuzhuang/import',
                    table: 'fuzhuang',
                }
            });
